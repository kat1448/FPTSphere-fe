...
export default function Step5Review({ onPrev }) {
  ...
  const handleSubmit = () => {
    Modal.confirm({
      ...
      onOk: async () => {
        try {
          // Event has already been created in Step1MainEvent
          // Sub-events have been created in Step2SubEvents
          // Tasks have been created in Step4Tasks
          // This step is just for final review and confirmation
          
          // Show success message
          notification.success({
            message: "Event Submitted Successfully!",
            description: "Your event has been created and is pending Director approval.",
            placement: "topRight",
            duration: 4,
            style: {
