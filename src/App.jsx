...
import AssignSubEventToStaff from "./pages/EventManager/AssignSubEventToStaff";
import CreateEventWizard from "./pages/EventManager/create-event/CreateEventWizard";
import TasksKanban from "./pages/EventManager/TasksKanban";
import StaffDashboard from "./pages/Staff/StaffDashboard";
import StaffTasksKanban from "./pages/Staff/StaffTasksKanban";
import StaffTaskDetail from "./pages/Staff/StaffTaskDetail";
import StaffInviteStudent from "./pages/Staff/StaffInviteStudent";
        ...
        <Router>
          ...
          <Routes>
            ...
            >
              ...
              {/* Director Event View - Director (2) */}
              <Route
                path="/director/events/:eventId/view"
                element={
                  <ProtectedRoute allowedRoleIds={[2]}>
                    <DirectorEventView />
                  </ProtectedRoute>
              ...
              {/* Event Manager Dashboard - Event Manager (3) - Shows assigned tasks */}
              <Route 
              ...
              {/* Event Manager Tasks Kanban - Event Manager (3) */}
              <Route 
                path="/event-manager/tasks/kanban" 
                element={
                  <ProtectedRoute allowedRoleIds={[3]}>
                    <TasksKanban />
                  </ProtectedRoute>
              ...
              {/* Event Manager Event View */}
              <Route 
                path="/event-manager/:eventId/view" 
                element={
                  <ProtectedRoute allowedRoleIds={[3]}>
                    <EventManagerEventView />
                  </ProtectedRoute>
                } 
              />

              {/* Assign Sub-Event Tasks to Staff - Event Manager (3) */}
              <Route 
                path="/event-manager/events/:eventId/assign-tasks" 
                element={
                  <ProtectedRoute allowedRoleIds={[3]}>
                    <AssignSubEventToStaff />
                  </ProtectedRoute>
                } 
              />
              ...
              {/* Staff Task Detail - Staff (4) */}
              <Route 
                path="/staff/taskDetail/:taskId" 
                element={
                  <ProtectedRoute allowedRoleIds={[4]}>
                    <StaffTaskDetail />
                  </ProtectedRoute>
              ...
              {/* Staff Invite Student - Staff (4) */}
              <Route 
                path="/staff/inviteStudent/:subEventId" 
                element={
                  <ProtectedRoute allowedRoleIds={[4]}>
                    <StaffInviteStudent />
                  </ProtectedRoute>
              ...
              {/* Staff Attendance - Staff (4) */}
              <Route 
                path="/staff/attendance/:subEventId" 
                element={
                  <ProtectedRoute allowedRoleIds={[4]}>
                    <StaffAttendance />
                  </ProtectedRoute>
